...
\begin{figure}[htb!]
	...
	\begin{subfigure}[b]{0.22\textwidth}
		...
		\label{subfig:right}
	\end{subfigure}
	\caption{Frames from one of the videos from AIR-Act2Act dataset~\cite{Ko2021} (the video depicts a scenario where the robot is supposed to bow to the elderly person who enters into the apartment)}
	\label{fig:hoora}
\end{figure}
