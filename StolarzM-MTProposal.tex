...
In this section we will introduce the motivation and goal of the master's thesis, as well as explain various terms related to adpatation techniques used in Human-Robot Interaction (HRI) field.
