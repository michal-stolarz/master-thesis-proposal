...
%\begin{table}[h]
{
	...
	\begin{longtable}{ |p{\widthsym}||p{\widthdesc}|p{\widthdel}|  }
		...
		\hline
		T2.1 & Selection of the available DL-based social behaviour learning architectures & \multirow{2}{\linewidth}{D2.1: Report with the description of the selected architectures and dataset}\\
		\cline{1-2}
